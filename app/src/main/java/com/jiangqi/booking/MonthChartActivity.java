...
import com.jiangqi.booking.adapter.ChartVPAdapter;
import com.jiangqi.booking.db.DBManager;
import com.jiangqi.booking.frag_chart.IncomChartFragment;
import com.jiangqi.booking.frag_chart.OutcomChartFragment;
...
//        将Fragment加载到Acitivy当中
    ...
    private void initStatistics(int year, int month) {
        float inMoneyOneMonth = DBManager.getSumMoneyOneMonth(year, month, 1,username);  //收入总钱数
        float outMoneyOneMonth = DBManager.getSumMoneyOneMonth(year, month, 0,username); //支出总钱数
        int incountItemOneMonth = DBManager.getCountItemOneMonth(year, month, 1,username);  //收入多少笔
        int outcountItemOneMonth = DBManager.getCountItemOneMonth(year, month, 0,username); //支出多少笔
