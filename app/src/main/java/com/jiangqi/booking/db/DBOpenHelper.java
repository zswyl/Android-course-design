...
//        创建表示类型的表
        ...
        sql = "create table accounttb(id integer primary key autoincrement,typename varchar(10),sImageId integer,beizhu varchar(80),money float," +
                "time varchar(60),year integer,month integer,day integer,kind integer,username varchar(255))";
        db.execSQL(sql);
        //创建预算表
        sql = "create table budgettb(id integer primary key autoincrement,money float,username varchar(255))";
        db.execSQL(sql);
    }
